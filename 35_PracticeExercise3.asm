...
; Practica 2. Programa #3. Realice un programa en lenguaje ensamblador para leer datos en el puerto C sacar el complemento y mostrarlo en el puerto B.
