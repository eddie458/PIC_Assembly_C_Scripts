...
; Practica 2. Programa #6. Realice un programa en lenguaje ensamblador para leer datos en el puerto C, restarle 5 y mostrarlo por el puerto B. Utilizar la instrucción sublw.
