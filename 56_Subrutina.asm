...
Principal	
;	movlw	NUMERO
	movf	PORTC,W					;W tiene el valor en binario.
	
	call	BIN_BCD					;Entrada W en binario, y salida en W en BDC.
	
	movwf	PORTB					;Se visualiza por el puerto de salida, muestra unidades y decenas.
	movf	Centenas,W
	movwf	PORTD
	goto	Principal
;	sleep						; Queda permanentemente en reposo.
	
;--------------------Empieza Zonas de Subrutinas--------------------	
