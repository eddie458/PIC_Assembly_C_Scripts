;***************************************************************
; Sistemas Digitales II		11-13		27 Febrero 2020.
; Practica 2. Programa #5. Realice un programa en lenguaje ensamblador para leer datos en el puerto C, restarle 4 y mostrarlo por el puerto B. Uitlizar la instrucción subwf.
