...
; Programa. Hacer un programa para generar una señal cuadrada por el pin 5 del puerto D.
; Utilice una subrutina para generar el retardo de tiempo de 65.5ms, realizado con el timer.
; Usar la tecina de polling. Configurar los registros: Option del TMR0.
...
CICLO
    bsf	    PORTD, RD5
    call    RETARDO_65			;Prender el bit 0 del PORTB.
    bcf	    PORTD, RD5
    call    RETARDO_65			;Apagar el bit 0 del puerto B.
    goto    CICLO
